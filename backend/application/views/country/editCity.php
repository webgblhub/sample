...
<div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Edit City</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <br><br>
                    <div class="form-group row">
                        <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>country/state/listofCity/<?php echo $city[0]->stateid; ?>" class="btn btn-success"><i class="ti-menu-alt"></i> City List</a>
                            </div>
                ...
                <div class="card-block">
                    <?php echo form_open_multipart('country/state/editCity/'.$city[0]->id); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="state" class="form-control" required>
                                  <option value="<?php echo $city[0]->stateid; ?>"><?php echo $city[0]->statename; ?></option> 
                                  <?php foreach($other as $o) { 
                                    if($o->name!= $city[0]->statename)
                                    {
                                        ?>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="city" class="form-control" placeholder="Type City" value="<?php echo $city[0]->name; ?>" required>
                            </div>
                        </div> 

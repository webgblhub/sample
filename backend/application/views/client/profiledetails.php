...
<div class="content-wrapper">
  ...
  <li class="nav-item " >
    <a class="nav-link active nav_itemss"  href="<?php echo base_url("client/profile/profileinfo")?>">Consumer Info</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo base_url("client/profile/businessinfo")?>">Business Info</a>
  </li>
 
</ul>
      <div class="row">

        <form enctype="multipart/form-data" method="post" action="<?php echo site_url('client/profile/update_profileinfo'); ?>">
        <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="city_id" id="en_city_id" class="form-control" placeholder="city" value="<?php echo $city; ?>">
...
?>
                  <div class="box-footer">
                      <button type="submit" name="submit" class="btn btn-primary pull-right form-btn">Save and Next</button>

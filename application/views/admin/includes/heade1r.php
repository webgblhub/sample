                ...
                <div class="header-fext-wrap">
                  ...
                  <div class="sect-header">
                    ...
                    <select class="top-nav-inp" onChange="location = this.options[this.selectedIndex].value;">
                      <option id="header-opt">StoreFront List</option>
                      <?php 
                      $i = 1;
                        foreach($store as $st)
                        {
                        ...
                        ?> 
                       <option  value="<?php echo base_url(); ?>supplier/edit/editBusinessInfo/<?php echo base64_encode($st->storeid); ?>" <?php if(!empty($this->uri->segment(4)) && base64_decode($this->uri->segment(4))== $st->storeid) { echo "selected"; } ?>  <?php if(round($percentage)==100) { echo "class='completed'" ;} ?>  ><?php echo $st->category . " &nbsp;&nbsp;  -&nbsp;&nbsp;   ".round($percentage)."%"; ?></option>

...
defined('BASEPATH') or exit('No direct script access allowed');
	...
	class Consumer_category extends CI_Controller
	{
...
;
			...
			$this->load->view('supplier/consumer_category/list', $data);
        ...
        function update($id){
			...
			if($this->form_validation->run() === FALSE){
				$this->load->view('administrator/header-script');
			   	$this->load->view('administrator/header');
			   	$this->load->view('administrator/header-bottom');
			   	$this->load->view('supplier/consumer_category/edit', $data);
			   	$this->load->view('administrator/footer');	
			}else{
                $data = array(
			    ...
			    redirect('supplier/consumer_category/lists');
			}
        }
        public function delete($id)
		{
            ...
            redirect('supplier/consumer_category/lists', 'refresh');
        ...
        public function add(){
            ...
            if($this->form_validation->run() === FALSE){
				$this->load->view('administrator/header-script');
			   	$this->load->view('administrator/header');
			   	$this->load->view('administrator/header-bottom');
			   	$this->load->view('supplier/consumer_category/add', $data);
			   	$this->load->view('administrator/footer');	
			}else{
                $data = array(
                    'event_categories' => $this->input->post('category'), 

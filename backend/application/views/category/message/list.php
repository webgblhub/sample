            ...
            <div class="page-body">
                ...
                <br>
                    <div class="form-group row">
                        <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>category/category/add_message" class="btn btn-success"><i class="ti-plus"></i>Add New</a>
                            </div>
                    ...
                    <div class="card-block">
                        <div class="table-responsive dt-responsive">
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                 <?php $i=1;foreach($message_lists as $lists) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        
                                        <td><a href="<?php echo base_url(); ?>category/category/update_message/<?php echo $lists['field']; ?>"></a><?php echo $lists['field']; ?></td>
                                        <td><a href="<?php echo base_url(); ?>category/category/update_message/<?php echo $lists['message']; ?>"></a><?php echo $lists['message']; ?></td>
                                        ...
                                        <td>
                                           ...
                                           <a class="label arf-primary disable"  href='<?php echo base_url(); ?>cultural_speciality/cultural_speciality/enable/<?php echo $cultural['cultural_speciality_id']; ?>?table=<?php echo base64_encode('cultural_speciality'); ?>'><i title="enable" class="ti-unlock"></i></a>&nbsp;&nbsp;&nbsp; 
                                            ...
                                            <?php endif; ?> -->
                                            <!-- Edit Button -->
                                            <!-- <a class="label arf-inverse-info" href='<?php echo base_url(); ?>category/category/view_message/<?php echo $lists['id']; ?>'><i title="edit" class="ti-eye"></i></a>&nbsp;&nbsp;&nbsp; -->

                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>category/category/update_message/<?php echo $lists['id']; ?>'><i title="edit" class="ti-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                                            <!-- Delete Button -->
                                             <!-- <a class="label arf-inverse-danger delete"  href='<?php echo base_url(); ?>category/category/delete_mail/<?php echo $lists['id']; ?>?table=<?php echo base64_encode('messages'); ?>'><i title="delete" class="ti-trash"></i></a> -->

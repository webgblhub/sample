            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List Districts</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <tbody>
                                 <?php $i=1;foreach($testimonials as $testimonial) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>district/update/<?php echo $testimonial['id']; ?>"></a><?php echo $testimonial['title']; ?></td>
                                        <td><?php echo $testimonial['code']; ?></td>
                                        <td>
                                            <?php if($testimonial['status'] == 1): ?>
                                           <a class="label label-inverse-primary enable" href='<?php echo base_url(); ?>administrator/enable/<?php echo $testimonial['id']; ?>?table=<?php echo base64_encode('districts'); ?>'>Enabled</a> 
                                            <?php else: ?> 
                                            <a class="label label-inverse-warning disable" href='<?php echo base_url(); ?>administrator/desable/<?php echo $testimonial['id']; ?>?table=<?php echo base64_encode('districts'); ?>'>Disabled</a>
                                            <?php endif; ?>
                                            <!-- Edit Button -->
                                            <a class="label label-inverse-info" href='<?php echo base_url(); ?>district/update/<?php echo $testimonial['id']; ?>'>Edit</a>
                                            <!-- Delete Button -->
                                            <a class="label label-inverse-danger delete" href='<?php echo base_url(); ?>administrator/delete/<?php echo $testimonial['id']; ?>?table=<?php echo base64_encode('districts'); ?>'>Delete</a>

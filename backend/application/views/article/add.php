...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Add Articles</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <div class="col-sm-12">
            ...
            <br><br>
                ...
                <div class="card-block">
                    <?php echo form_open_multipart('article/article/add'); ?>
                    <div class="form-group row">
                                ...
                                <option value="">--Select--</option>
                                 <?php
                                     foreach ($get_category as $cat) {
                                         //$selected = ($carrier_data->region_a_code == $region->region_agent_id) ? ' selected ' : '';
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="question" class="form-control" placeholder="Type Question">
                            </div>
                        </div> 
                        <div class="form-group row">

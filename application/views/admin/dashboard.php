          ...
          <div class="container navigation-cont-wrap">
            <nav id="navigation-bar" class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav">
                   <li class="nav-item">
                    <a class="nav-link" id="dash-link" href="<?php echo base_url('supplier/create/')?>">Dashboard</a>
                    <div class="line"></div>
                  </li>
                  
                  <li class="nav-item active" id="dash-link-sub">
                    <a class="nav-link" id="dash-link-sub-link"  href="<?php echo base_url('supplier/create/addStoreFront/')?>">New StoreFront</a>
...
<form method="get">
        ...
        <div class="inner">
            ...
            <select name="ser" id="ser" class="form-control" onchange="manage(this.value)" required>
            <option value="">Select</option>
            <option value="all" <?php if($this->input->get('ser')=='all') { ?> selected="selected"<?php } ?>>All</option>
            <option value="30" <?php if($this->input->get('ser')=='30') { ?> selected="selected"<?php } ?>>30 Days</option>
            <option value="60" <?php if($this->input->get('ser')=='60') { ?> selected="selected"<?php } ?>>60 Days</option>
            ...
            <div class="col-lg-3 col-xs-3 yearblock">
            <div class="form-group">
            <?php $years = range(2000, strftime("%Y", time())); ?>
            <select class="form-control " name="year" id="year" disabled="disabled" required>
              <option value="">Select Year</option>
              <?php foreach($years as $year) : ?>
                <option value="<?php echo $year; ?>" <?php if($this->input->get('year')==$year) { ?> selected="selected"<?php } ?>><?php echo $year; ?></option>
              <?php endforeach; ?>
            ...
            <div class="col-lg-3 col-xs-3 monthblock">
            <div class="form-group">
            <select id="month" name="month" class="form-control " required disabled="disabled">
              <option value="">Select Month</option>
              <option value="01" <?php if($this->input->get('month')=='01') { ?> selected="selected"<?php } ?>>January</option>
              <option value="02" <?php if($this->input->get('month')=='02') { ?> selected="selected"<?php } ?>>February</option>
              <option value="03" <?php if($this->input->get('month')=='03') { ?> selected="selected"<?php } ?>>March</option>
            ...
            <div class="col-lg-3 col-xs-3 datefromblock">
            <div class="form-group">
            <input type="date" name="datfrom" id="datfrom" class="form-control " required disabled="disabled" value="<?php echo $this->input->get('datfrom') ?>" />
            </div>
            </div>
            <div class="col-lg-3 col-xs-3 datetoblock">
            <div class="form-group">
            <input type="date" name="datto" id="datto" class="form-control " required disabled="disabled" value="<?php echo $this->input->get('datto') ?>" />
            </div>
            </div>
            <div class="col-lg-3 col-xs-3">
            <div class="form-group">
            <button type="submit" name="butSub" id="butSub" class="btn btn-success">Search</button>
            </div>
            </div>
            </form>
            </div>
            ...
            <div class="small-box border border-success rounded">
            	<canvas id="chart-area"></canvas>
                </div>
            </div>
            <div class="col-lg-6 col-xs-6">

<div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>category/category/business_category_lists">Categories</a>
                        </li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>category/category/business_category_lists" class="btn btn-success"><i class="ti-menu-alt"></i>Back to List</a>
                                </div>
                            ...
                            <div class="card-block">
                                ...
                                <!-- <h4><?= $title ?></h4> -->
                                <?php echo form_open_multipart('category/category/update_business_category/'.$bus_categories['id']); ?>

            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Discount List</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
                ...
                <div class="card">
                    ...
                    <div class="form-group row">
                         <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>discount/discountType/addDiscount" class="btn btn-success"><i class="ti-plus"></i>Add Discount</a>
                            </div>
                                ...
                                <tbody>
                                 <?php $i=1;foreach($disc as $d) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($d->status == 0): ?>
                                           <a class="label arf-warning enable" href='<?php echo base_url(); ?>discount/discountType/enable/<?php echo $d->discount_id; ?>'><i class="ti-lock" title="Enable"></i></a> 
                                            <?php else: ?> 
                                            <a class="label arf-primary disable" href='<?php echo base_url(); ?>discount/discountType/disable/<?php echo $d->discount_id; ?>'><i class="ti-unlock" title="Disable"></i></a>
                                            <?php endif; ?>
                                           
                                           <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>discount/discountType/editDiscount/<?php echo $d->discount_id; ?>'><i class="ti-pencil" title="Edit"></i></a>

                                             
                                            <!-- Delete Button -->
                                            <a class="label arf-inverse-danger delete" href='<?php echo base_url(); ?>discount/discountType/deleteDiscount/<?php echo $d->discount_id; ?>'><i class="ti-trash" title="Delete"></i></a>
                                            <!-- Pachage Button -->

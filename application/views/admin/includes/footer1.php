...
<div class="footer-cont">
       ...
       <?php   } ?>
               ...
               <span id="footer-text-wrapper"><span id="footer-text">Terms & Condition</span> | <span id="footer-text">Privacy Policy</span> | Copyright © 2020, Plan Tech, Inc (PTI) and EventsDragon.Com (EDC).</span>
             </div>	
               </div>
             </div>
             </div>

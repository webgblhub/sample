                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="card-block">
                                ...
                                <?php echo form_open_multipart('category/category/update_content/'.$get_body->id); ?>
                                    <input type="hidden" name="id" value="<?php echo $get_body->id; ?>">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label"> Mail Category</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="category" value="<?php echo $get_body->category;?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">

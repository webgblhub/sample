        ...
        <div class="col-sm-12">
            ...
            <br><br>
                <div class="form-group row">
                    <div class="col-sm-2">
                        <a href="<?php echo base_url("supplier/edit/lead_list/".$lead_details->store_front_id) ?> "class="btn btn-success"><i class="ti-menu-alt"></i>Back to List</a>
                    </div>

                     <label class="col-sm-10"><a href="<?php echo base_url("supplier/edit/chat_history/".$lead_details->lead_id.'/'.$lead_details->store_front_id.'/0') ?> "class="btn btn-primary" title="Chat History"><i class="ti-comments-smiley" ></i></a></label>

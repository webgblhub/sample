        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <?php echo form_open_multipart('country/state/editState'); ?>
                       ...
                       <br><br>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="code" id="statecode" class="form-control" placeholder="Type State Code" value="<?php echo $state[0]->iso2; ?>" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="state" class="form-control" placeholder="Type State" value="<?php echo $state[0]->name; ?>" required>
                            </div>
                        </div> 
                       ...
                       <!--  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <button type="submit" name="submit" class="btn btn-primary" id="sub">Update</button>
                            </div>
                        </div>

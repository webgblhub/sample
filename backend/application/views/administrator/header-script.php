...
<head>
    <title>Administrator - <?php if(!empty($title)) {echo $title;} else {echo "Events Dragon";} ?></title>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo base_url(); ?>assets/images/logo1.png" sizes="16x16" type="image/gif">
    <!-- Google font-->

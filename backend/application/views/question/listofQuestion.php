            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List of Question</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
                ...
                <div class="card">
                    ...
                    <div class="form-group row">
                            <div class="col-sm-2">
                             <a href="<?php echo base_url(); ?>question/questions/addQuestion" class="btn btn-success"><i class="ti-plus"></i>Add Question</a></div>
                            ...
                            <div class="col-sm-3">
                                <select name="category" class="form-control" onchange="location = this.options[this.selectedIndex].value;">
                                    <option value="<?php echo base_url('question/questions/') ?>" <?php if($s=="no") {?> selected <?php } ?>>Sort by Category</option>
                                    <?php foreach ($cat as $c)
                                    { ?>
                                      <option value="<?php echo base_url('question/questions/index/'.$c->cat_id) ?>" <?php if($s==$c->cat_id) {?> selected <?php } ?>><?php echo $c->category ?></option>
                                   <?php } ?>
                               </select>
                                ...
                                <tbody>
                                 <?php $i=1;foreach($ques as $q) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo ucfirst($q->ques_type);; ?></td>
                                        <td><?php echo $q->category; ?></td>
                                        <td>
                                            
                                           
                                           <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>question/questions/editQuestion/<?php echo $q->id; ?>'><i class="ti-pencil" title="Edit"></i></a>

                                             
                                            <!-- Delete Button -->
                                            <a class="label arf-inverse-danger delete" href='<?php echo base_url(); ?>question/questions/deleteQuestion/<?php echo $q->id; ?>'><i class="ti-trash" title="Delete"></i></a>
                                            <!-- Pachage Button -->

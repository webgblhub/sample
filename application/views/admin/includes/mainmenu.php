            ...
            <nav id="navigation-bar" class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item" id="dash-link-sub">
                    <a class="nav-link" id="dash-link-sub-link" href="<?php echo base_url('supplier/create/add_bankdetail/'.$switching.'/'.$categories)?>">Payments</a>
                ...
                <?php } else if($ctrler=='edit' || $ctrler=='supplier' || $ctrler=='calendar' ||  $page=='storefrontDashboard'){ ?>
                  ...
                  <li class="nav-item" id="dash-link-sub">
                    <!--<i class='fas fa-book-open'></i> -->
                   <a class="nav-link list" id="dash-link-sub-link" href="<?php echo base_url('supplier/edit/booked_Lead_list/'.$switching) ?>">Bookings</a>
                  ...
                  <a class="dropdown-item" href="<?php echo base_url('supplier/edit/edit_promo_info/'.$switching) ?>">Public Promo</a>
                      <a class="dropdown-item" id="dash-link-sub-link" href="<?php echo base_url('supplier/edit/update_bankdetail/'.$switching) ?>">Payments</a>
                    </div>
                  </li>
                    <li class="nav-item" id="dash-link-sub">

...
$busid = $busid = $this->uri->segment(6);
...
<div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"> Add Suppliers Product Packages</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Supplier Product Packages</h5>
            ...
            <div class="modal-content">
                    ...
                    <form enctype="multipart/form-data" method="post" action="<?php echo site_url('supplier/create/add_products'); ?>">
                      ...
                      <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                        ...
                        <div class="form-group">
                          ...
                          <?php if(set_value('pro_image')){ $pro_image = set_value('pro_image'); } elseif (isset($service) &&$service) { $pro_image2 = $article->image; } ?>
                          ...
                          <?php if($pro_image2){ ?>
                            <a class="fa fa-file"style="font-size:16px;" href = "<?php echo base_url('uploads/'.$pro_image2)?>" target="_blank">view file</a>
                          <?php }else{ ?>
                ...
                <div class="col-md-11">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary pull-right form-btn" >SUBMIT</button>
                                    ...
                                    <!-- table list -->
                                    <?php /*?><form enctype="multipart/form-data" method="post" action="<?php echo site_url('supplier/create/add_bankdetail/'.$this->uri->segment(4)."/".$this->uri->segment(5)."/".$this->uri->segment(6)); ?>"><?php */?>
                                    <a href="<?php echo site_url('supplier/create/add_bankdetail/'.$this->uri->segment(4)."/".$this->uri->segment(5)."/".$this->uri->segment(6)); ?>" type="submit" name="submit" class="btn btn-primary pull-right form-btn">Next</a>
                                  <?php /*?></form><?php */?>

                                  </div>
                                <?php }else { ?>
                                  <form enctype="multipart/form-data" method="post" action="<?php echo site_url('supplier/create/add_productpackages/'.$this->uri->segment(4)."/".$this->uri->segment(5)."/".$this->uri->segment(6)); ?>">
                                  <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="product_number" id="en_title" class="form-control" placeholder="Enter Product Number" value="<?php echo $product_number; ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Product Details</label>
                      <?php if(set_value('product_detail')){ $product_detail = set_value('product_detail'); } elseif (isset($service) &&$service) { $product_detail = $service[0]['product_detail']; } ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Product Video</label>
                      <?php if(set_value('product_video')){ $Company_name = set_value('product_video'); } elseif (isset($service) &&$service) { $product_video = $service[0]['product_video']; } ?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <?php if(set_value('peakdays')){ $peakdays = set_value('peakdays'); } elseif (isset($service) &&$service) { $peakdays = $service[0]['supplier_peak_days']; } ?> -->
                ...
                <div class="row">
                   <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <?php if(set_value('peakmonths')){ $peakmonths = set_value('peakmonths'); } elseif (isset($service) &&$service) { $peakmonths = $service[0]['supplier_peak_month']; } ?> -->
                ...
                <div class="modal-body">
                    ...
                    <form enctype="multipart/form-data" method="post" action="<?php echo site_url('supplier/create/add_products'); ?>">
                      ...
                      <div class="form-group">
                          <?php if(set_value('product_name')){ $product_name = set_value('product_name'); } elseif (isset($service) &&$service) { $product_name = $service[0]['product_name']; } ?>
                            <label for="inputName">Product Name</label>
                            <input type="text" name="product_name" id="en_title" class="form-control" placeholder="Product Name" >
                          </div>
                        </div>
                         <div class="col-md-6">
                        <div class="form-group">
                      <label>Product Number</label>
                      <?php if(set_value('product_number')){ $product_number = set_value('product_number'); } elseif (isset($service) &&$service) { $product_number = $service[0]['product_number']; } ?>
                      <input type="number" name="product_number" id="product_number" class="form-control" placeholder="Product Number" >
                      </div>
                    </div>
                        <div class="col-md-6">
                        <div class="form-group">
                          <label>Product Price</label>
                          <?php if(set_value('product_price')){ $product_price = set_value('product_price'); } elseif (isset($service) &&$service) { $product_price = @$service[0]['price']; } ?>
                          <input type="number" name="product_price" id="en_title" class="form-control" placeholder="product price" onkeypress="return isNumberKey(event)">
                          </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                          <label>Product Details</label>
                          <?php if(set_value('product_detail')){ $product_detail = set_value('product_detail'); } elseif (isset($service) &&$service) { $product_detail = @$service[0]['description']; } ?>
                          <input type="text" name="product_detail" id="en_product_detail" class="form-control" placeholder="produt details" >
                          </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
                          <label>Product Video</label>
                          <?php if(set_value('product_video')){ $Company_name = set_value('product_video'); } elseif (isset($service) &&$service) { $product_video = @$service[0]['video']; } ?>
                          <input type="url" name="product_video" id="en_product_video" class="form-control" placeholder="video link here" >
                          </div>
                        </div>

            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List Articles</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
                ...
                <br>
                    <div class="form-group row">
                        <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>article/article/add" class="btn btn-success"><i class="ti-plus"></i>Add New</a>
                            </div>
                                ...
                                <tbody>
                                 <?php $i=1;foreach($article as $art) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>article/article/update/<?php echo $art['id']; ?>"></a><?php echo $art['category']; ?></td>
                                        <td><a href="<?php echo base_url(); ?>article/article/update/<?php echo $art['id']; ?>"></a><?php echo $art['Question']; ?></td>
                                        <td><a href="<?php echo base_url(); ?>article/article/update/<?php echo $art['id']; ?>"></a><?php echo $art['Answer']; ?></td>
                                        ...
                                        <td>
                                            <!-- <?php if($art['status'] == 1): ?>
                                           <a class="label arf-primary disable"  href='<?php echo base_url(); ?>article/article/enable/<?php echo $art['id']; ?>?table=<?php echo base64_encode('questionnaire_articles'); ?>'><i title="enable" class="ti-unlock"></i></a>&nbsp;&nbsp;&nbsp; 
                                            <?php else: ?> 
                                            <a class="label arf-warning enable" href='<?php echo base_url(); ?>article/article/desable/<?php echo $art['id']; ?>?table=<?php echo base64_encode('questionnaire_articles'); ?>'><i title="disable" class="ti-lock"></i></a>&nbsp;&nbsp;&nbsp;
                                            <?php endif; ?> -->
                                            <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>article/article/update/<?php echo $art['id']; ?>'><i title="edit" class="ti-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                                            <!-- Delete Button -->

                                             <a class="label arf-inverse-danger delete"  href='<?php echo base_url(); ?>article/article/delete/<?php echo $art['id']; ?>?table=<?php echo base64_encode('questionnaire_articles'); ?>'><i title="edit" class="ti-trash"></i></a>

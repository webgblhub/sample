        ...
        <div class="col-sm-12">
            ...
            <br><br>
                ...
                <div class="card-block">
                    <?php echo form_open_multipart('category/category/add_business_category'); ?>
                        
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Business Category</label>
                            <div class="col-sm-10">
                                <input type="text" name="category" class="form-control" placeholder="Type Business Category Name">
                            </div>
                        </div> 

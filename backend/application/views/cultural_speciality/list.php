            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List Cultural Specialities</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
                ...
                <br>
                    <div class="form-group row">
                        <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>cultural_speciality/cultural_speciality/add" class="btn btn-success"><i class="ti-plus"></i>Add New</a>
                            </div>
                        ...
                        <div class="table-responsive dt-responsive">
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Cultural Speciality Name</th>
                                ...
                                <tbody>
                                 <?php $i=1;foreach($cultural_speciality as $cultural) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        
                                        <td><a href="<?php echo base_url(); ?>cultural_speciality/cultural_speciality/update/<?php echo $cultural['cultural_speciality_id']; ?>"></a><?php echo $cultural['cultural_speciality']; ?></td>
                                        ...
                                        <td>
                                           ...
                                           <a class="label arf-primary disable"  href='<?php echo base_url(); ?>cultural_speciality/cultural_speciality/enable/<?php echo $cultural['cultural_speciality_id']; ?>?table=<?php echo base64_encode('cultural_speciality'); ?>'><i title="enable" class="ti-unlock"></i></a>&nbsp;&nbsp;&nbsp; 
                                            ...
                                            <?php endif; ?>
                                            <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>cultural_speciality/cultural_speciality/update/<?php echo $cultural['cultural_speciality_id']; ?>'><i title="edit" class="ti-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                                            <!-- Delete Button -->

                                             <a class="label arf-inverse-danger delete"  href='<?php echo base_url(); ?>cultural_speciality/cultural_speciality/delete/<?php echo $cultural['cultural_speciality_id']; ?>?table=<?php echo base64_encode('cultural_speciality'); ?>'><i title="edit" class="ti-trash"></i></a>

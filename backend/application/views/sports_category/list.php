            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List Sports Categories</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
                ...
                <br>
                    <div class="form-group row">
                        <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>sports_category/sports_category/add" class="btn btn-success"><i class="ti-plus"></i>Add New</a>
                            </div>
                    ...
                    <div class="card-block">
                        <div class="table-responsive dt-responsive">
                            <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                 <?php $i=1;foreach($sports_category as $category) : ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        
                                        <td><a href="<?php echo base_url(); ?>sports_category/sports_category/update/<?php echo $category['id']; ?>"></a><?php echo $category['name']; ?></td>
                                    

                                        <td>
                                            <?php if($category['status'] == 1): ?>
                                           <a class="label arf-primary disable"  href='<?php echo base_url(); ?>sports_category/sports_category/enable/<?php echo $category['id']; ?>?table=<?php echo base64_encode('sports_category'); ?>'><i title="enable" class="ti-unlock"></i></a>&nbsp;&nbsp;&nbsp; 
                                            <?php else: ?> 
                                            <a class="label arf-warning enable" href='<?php echo base_url(); ?>sports_category/sports_category/desable/<?php echo $category['id']; ?>?table=<?php echo base64_encode('sports_category'); ?>'><i title="disable" class="ti-lock"></i></a>&nbsp;&nbsp;&nbsp;
                                            <?php endif; ?>
                                            <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>sports_category/sports_category/update/<?php echo $category['id']; ?>'><i title="edit" class="ti-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                                            <!-- Delete Button -->

                                             <a class="label arf-inverse-danger delete"  href='<?php echo base_url(); ?>sports_category/sports_category/delete/<?php echo $category['id']; ?>?table=<?php echo base64_encode('sports_category'); ?>'><i title="edit" class="ti-trash"></i></a>

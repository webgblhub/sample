    ...
    <style type="text/css">
            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Booked List</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
               <div class="row" style="margin-left: 0%">
                                ...
                                <a href="<?php echo site_url('supplier/edit/lead_list/'.$data['sup'][0]->id); ?>" class="btn btn-success bor">Lead</a>
                                 ...
                                 <a href="<?php echo site_url('supplier/edit/booked_Lead_list/'.$data['sup'][0]->id); ?>" class="btn btn-primary active bor">Booked</a>
            ...
            <div class="card">
                 <br><br>
                    ...
                    <h5>List Lead Booked - <?php echo $categoryname[0]->category; ?> - <?php echo $categoryname[0]->company_name; ?></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($lead->estatus == 'booked'){ ?>
                                                <a class="label arf-primary enable"><i class="ti-gift" title="Booked"></i></a> 
                                                <a class="label arf-warning disable" ><i class="ti-flag" title="Flagged"></i></a>
                                                <a class="label arf-warning disable"><i class="ti-trash" title="Trashed"></i></a>

                                            <?php } else if($lead->estatus == 'flagged') {?> 
                                           ...
                                           <a class="label arf-inverse-primary" href='<?php echo base_url(); ?>supplier/edit/view_booked_lead/<?php echo $lead->lead_id; ?>'><i class="ti-eye" title="View  Details"></i></a>

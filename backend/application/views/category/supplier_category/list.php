            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>category/category/supplier_category_lists">Supplier Categories</a>
                        </li>
            ...
            <div class="page-body">
                ...
                <br>
                    <div class="form-group row">
                            <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>category/category/add_supplier_category" class="btn btn-success"><i class="ti-plus"></i>Add New</a>
                            </div>
                                ...
                                <tbody>
                                 <?php $i=1;foreach($testimonials as $testimonial) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>category/category/category/<?php echo $testimonial['cat_id']; ?>"></a><?php echo $testimonial['category']; ?></td>
                                    	<td><?php echo ($testimonial['dyn_status']==1)?"Yes":"No"; ?></td>

                                        <td>
                                            <?php if($testimonial['display'] == 0): ?>
                                           <a class="label arf-primary disable"  href='<?php echo base_url(); ?>category/category/enable_supplier_category/<?php echo $testimonial['cat_id']; ?>?table=<?php echo base64_encode('supplier_category'); ?>'><i title="enable" class="ti-unlock"></i></a>&nbsp;&nbsp;&nbsp; 
                                            <?php else: ?> 
                                            <a class="label arf-warning enable" href='<?php echo base_url(); ?>category/category/desable_supplier_category/<?php echo $testimonial['cat_id']; ?>?table=<?php echo base64_encode('supplier_category'); ?>'><i title="disable" class="ti-lock"></i></a>&nbsp;&nbsp;&nbsp;
                                            <?php endif; ?>
                                            <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>category/category/update_supplier_category/<?php echo $testimonial['cat_id']; ?>'><i title="edit" class="ti-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                                            <!-- Delete Button -->

                                             <a class="label arf-inverse-danger delete"  href='<?php echo base_url(); ?>category/category/delete_supplier_category/<?php echo $testimonial['cat_id']; ?>'><i title="delete" class="ti-trash"></i></a>

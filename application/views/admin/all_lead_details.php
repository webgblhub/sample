 ...
 <section class="final-container-section">
          ...
          <div class="container-list-flex">
            <div class="row row-container-list">
              ...
              <form enctype="multipart/form-data"  id="comment" method="post" action="<?php echo base_url() ?>supplier/edit/send_enquiry_from_all/<?php echo base64_encode($switching); ?>/<?php echo base64_encode($lead->from_id); ?>/<?php echo base64_encode($lead->lead_id); ?>">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="leads-detail-row-cont">
                          <div class="contact-area">
                            ...
                            <input type="file" name="file" id="chatupload"/><a id="upload_link"><i class="fa fa-paperclip"></i></a><label id="file_uploaded" class="uploadedname_path"></label>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="leads-detail-row-cont  leads-button-cont">
                          <a href="<?php echo base_url() ?>supplier/edit/send_enquiry_from_all/<?php echo base64_encode($switching); ?>/<?php echo base64_encode($lead->from_id); ?>/<?php echo base64_encode($lead->lead_id); ?>/<?php base64_encode('not_inter') ?>" > <button class="leades-btn"> Not Intrested</button></a>
                           <a href="<?php echo base_url() ?>supplier/edit/send_enquiry_from_all/<?php echo base64_encode($switching); ?>/<?php echo base64_encode($lead->from_id); ?>/<?php echo base64_encode($lead->lead_id);?>/<?php base64_encode('not_avail') ?>"><button class="leades-btn">Not Available </button></a>

...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Add Cultural Specialities</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <div class="col-sm-12">
            ...
            <br><br>
                ...
                <div class="card-block">
                    <?php echo form_open_multipart('cultural_speciality/cultural_speciality/add'); ?>
                        
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Cultural Speciality</label>
                            <div class="col-sm-10">
                                <input type="text" name="cultural" class="form-control" placeholder="Type a cultural speciality Name">
                            </div>
                        </div> 

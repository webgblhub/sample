...
$route['administrator/albums/create'] = 'administrator/create_product';
$route['administrator/albums'] = 'administrator/get_products';
$route['administrator/albums/update/(:any)'] = 'administrator/update_products/$1';

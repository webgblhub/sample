                               ...
                               <?php echo form_open_multipart('administrator/update_user_data'); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select class="form-control form-control-primary" name="role" id="role">
                                            <?php foreach($roles as $item) { ?>
                                            <option value="<?php echo $item['id'] ?>" <?php echo ($item['id']==$user['role_id'])?'selected':''; ?>><?php echo $item['title'] ?></option>
                                            <?php } ?>
                                            </select>
                                    ...
                                    <?php if($this->session->userdata('role')==2) {  ?>
                                            <?php /*?><select class="form-control form-control-primary" name="role" id="role">
                                            <?php foreach($roles as $item) { if($item[id]==3) { ?>
                                            <option value="<?php echo $item['id'] ?>" <?php echo ($item['id']==$user['role_id'])?'selected':''; ?>><?php echo $item['title'] ?></option>
                                            <?php } } ?>
                                            </select><?php */?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control form-control-primary" name="district" id="district">
                                            <option value="">Select</option>
                                            <?php foreach($districts as $item) { ?>
                                            <option value="<?php echo $item['id'] ?>" <?php echo ($item['id']==$user['district_id'])?'selected':''; ?>><?php echo $item['title'] ?></option>
                                            <?php } ?>
                                            </select>
                                    ...
                                    <?php } ?>
                                    <?php if($this->session->userdata('role')==2) { ?>
                                    <input type="hidden" name="district" id="district" value="<?php echo $this->session->userdata('district'); ?>" />
                                    <?php } ?>
                                    <div class="form-group row">

...
$count=$this->Create_Model->selectProfileStatus($switching);

$c=count($store);

$percentage=(100/27)*$count;
...
?>    
        <section>
         <div class="contaier dash-board-container-wrper">
           ...
           <h5>Your Storefront is <?php echo round($percentage); ?>% complete.  Please provide any missing info,bringing you to 100%,so we can publish your storefront!</h5><br>
           <?php } ?>

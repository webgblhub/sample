<div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>supplier/supplier_category/lists">Categories</a>
                        </li>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <h4><?= $title ?></h4>
                                <?php echo form_open_multipart('supplier/supplier_category/update/'.$categories['cat_id']); ?>

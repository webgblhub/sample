            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">List City</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="page-body">
                ...
                <div class="card">
                    ...
                    <div class="form-group row">
                         <div class="col-sm-2">
                                <a href="<?php echo base_url(); ?>country/state/addCity/<?php echo $city[0]->state_id; ?>" class="btn btn-success"><i class="ti-plus"></i>Add City</a>
                            </div>
                                 ...
                                 <?php $i=1;foreach($city as $c) : ?>
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <!-- Edit Button -->
                                            <a class="label arf-inverse-info" href='<?php echo base_url(); ?>country/state/editCity/<?php echo $c->id; ?>'><i class="ti-pencil" title="Edit"></i></a>

                                             
                                            <!-- Delete Button -->
                                            <a class="label arf-inverse-danger delete" href='<?php echo base_url(); ?>country/state/deleteCity/<?php echo $c->id; ?>?table=<?php echo base64_encode('event_dragon_users'); ?>'><i class="ti-trash" title="Delete"></i></a>
                                            <!-- Pachage Button -->
